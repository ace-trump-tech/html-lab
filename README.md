...
| **图片裁剪** | [image-cropper/](https://ace-trump-tech.github.io/html-lab/image-cropper/) | 鼠标拖拽选择裁剪区域，自由选区，纯前端预览和下载。 |
| **图片尺寸调整** | [image-resizer/](https://ace-trump-tech.github.io/html-lab/image-resizer/) | 像素/百分比缩放，支持等比例锁定，含常用预设尺寸。 |
| **图片旋转/翻转** | [image-rotator/](https://ace-trump-tech.github.io/html-lab/image-rotator/) | 90°/180° 旋转，水平/垂直镜像翻转，实时预览。 |
| **图片水印** | [image-watermark/](https://ace-trump-tech.github.io/html-lab/image-watermark/) | 添加文字水印，可自定义文字、位置、透明度和字号。 |
| **九格切图** | [image-9grid/](https://ace-trump-tech.github.io/html-lab/image-9grid/) | 将图片切割为 3×3 九宫格，每格可单独下载。 |
| **渐变图制作** | [gradient-generator/](https://ace-trump-tech.github.io/html-lab/gradient-generator/) | 可视化生成 CSS 线性/径向渐变，可复制代码或下载图片。 |
| **文字转图** | [text-to-image/](https://ace-trump-tech.github.io/html-lab/text-to-image/) | 将文字渲染为 PNG 图片，可自定义颜色、字号和背景色。 |
| **简易图片编辑** | [image-editor/](https://ace-trump-tech.github.io/html-lab/image-editor/) | 调节亮度、对比度、饱和度、模糊等基础参数。 |
...
| **UUID 生成器** | [uuid-generator/](https://ace-trump-tech.github.io/html-lab/uuid-generator/) | 使用 crypto.randomUUID()，小写/大写/无连字符，批量生成。 |
| **Lorem Ipsum 生成器** | [lorem-ipsum/](https://ace-trump-tech.github.io/html-lab/lorem-ipsum/) | 拉丁/中文假文，支持段落/句子/单词模式。 |
| **哈希生成器** | [hash-generator/](https://ace-trump-tech.github.io/html-lab/hash-generator/) | MD5 / SHA-1 / SHA-256 / SHA-512 摘要，基于 CryptoJS。 |
| **随机数生成器** | [random-number/](https://ace-trump-tech.github.io/html-lab/random-number/) | 指定范围生成整数/小数，支持批量生成。 |

### 📐 格式化/校验（5 件）

| 工具名称 | 直达链接 | 功能说明 |
|---------|----------|----------|
| **JSON 格式化 & 校验** | [json-formatter/](https://ace-trump-tech.github.io/html-lab/json-formatter/) | 格式化、压缩、校验 JSON，语法高亮，错误定位，转义/去转义。 |
...
| 工具名称 | 直达链接 | 功能说明 |
|---------|----------|----------|
| **正则表达式测试器** | [regex-tester/](https://ace-trump-tech.github.io/html-lab/regex-tester/) | 实时高亮匹配，显示捕获分组与匹配位置。 |
| **大小写转换** | [case-converter/](https://ace-trump-tech.github.io/html-lab/case-converter/) | UPPER / lower / Title / 驼峰 / 蛇形 / 短横等转换。 |
| **文本去重** | [text-dedup/](https://ace-trump-tech.github.io/html-lab/text-dedup/) | 逐行去重，大小写敏感、去除空格、保留空行选项。 |
| **文本排序** | [text-sorter/](https://ace-trump-tech.github.io/html-lab/text-sorter/) | 字母升序/降序、数字排序、随机打乱、反转顺序。 |
| **数字转中文** | [number-to-chinese/](https://ace-trump-tech.github.io/html-lab/number-to-chinese/) | 简体小写/繁体大写/人民币大写。 |
| **中文转拼音** | [chinese-to-pinyin/](https://ace-trump-tech.github.io/html-lab/chinese-to-pinyin/) | 带声调/数字声调/无声调三种模式。 |
...
| **颜色工具** | [color-tools/](https://ace-trump-tech.github.io/html-lab/color-tools/) | 颜色拾取器，HEX / RGB / HSL 三者实时互转，CSS 一键复制。 |
...
| **二维码解析** | [qr-decoder/](https://ace-trump-tech.github.io/html-lab/qr-decoder/) | 上传含二维码的图片，解析出编码内容。 |
| **URL 解析器** | [url-parser/](https://ace-trump-tech.github.io/html-lab/url-parser/) | 解析 URL 各组成部分：协议/主机/路径/参数/片段。 |
| **计算器** | [calculator/](https://ace-trump-tech.github.io/html-lab/calculator/) | 四则运算、支持括号和键盘输入。 |
| **日期计算器** | [date-calculator/](https://ace-trump-tech.github.io/html-lab/date-calculator/) | 日期间隔天数、日期加减推算。 |
| **BMI 计算器** | [bmi-calculator/](https://ace-trump-tech.github.io/html-lab/bmi-calculator/) | 体重指数计算、理想体重和体脂估算。 |
| **亲戚称呼计算器** | [kinship-calculator/](https://ace-trump-tech.github.io/html-lab/kinship-calculator/) | 中国式亲戚关系查询、称呼对照表。 |
...
3. 在根目录 `index.html` 的对应分类中添加工具卡片和炼器总览条目。
4. 提交并推送：
   ```bash
   git add .
